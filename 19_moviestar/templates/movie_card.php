...
<div class="card movie-card">
  <div class="card-img-top" style="background-image: url('<?= $BASE_URL ?>img/movies/<?= htmlspecialchars($movie->image) ?>')"></div>
  <div class="card-body">
    <p class="card-rating">
    ...
    <h5 class="card-title">
      <a href="<?= $BASE_URL ?>movie.php?id=<?= $movie->id ?>"><?= htmlspecialchars($movie->title) ?></a>
    </h5>
