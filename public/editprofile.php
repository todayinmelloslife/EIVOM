...
?>
  <div id="main-container" class="container-fluid edit-profile-page">
    <div class="col-md-12">
      <form action="<?= $BASE_URL ?>../mvc/controller/user_process.php" method="POST" enctype="multipart/form-data">
      ...
      <div class="row" id="change-password-container">
        <div class="col-md-4">
          ...
          <form action="<?= $BASE_URL ?>../mvc/controller/user_process.php" method="POST">
